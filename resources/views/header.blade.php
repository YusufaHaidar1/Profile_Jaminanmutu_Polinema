        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <ul class="navbar-nav ms-auto">
              <li class="nav-item">
                <a class="nav-link" id="navbarBeranda" href="#" aria-haspopup="true" aria-expanded="false">
                  Beranda
                </a>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" id="navbarProfil" data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                  Profil
                </a>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" id="navbarSPMI" data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                  SPMI
                </a>
                <div class="dropdown-menu" aria-labelledby="navbarProfil">
                    <div class="row gx-0">
              ...
              <li class="nav-item">
                <a class="nav-link" id="navbarAkreditasi" data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                  Akreditasi
                </a>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" id="navbarPelayanan" data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                  Pelayanan
                </a>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" id="navbarSIJAMU" data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                  SIJAMU
                </a>
