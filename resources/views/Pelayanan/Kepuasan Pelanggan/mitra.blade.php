...
<body>
        ...
        <div class="container">
          <div class="row align-items-center justify-content-between">
            <div class="col-12 col-md-5 order-md-2">
              ...
              <!-- Heading -->
              <h2>
                INDIKATOR KEPUASAN PARTNER
              </h2>

              <!-- Figure -->
                <figure class="figure mb-7">
                    <img class="figure-img img-fluid rounded lift lift-lg" src="assets/img/kepuasan pelanggan/mitra/Indikator.png" alt="...">
                </figure>
                ...
                <div class="card-body">
                    ...
                    <form class="rounded shadow" style="margin-bottom: 20px;" id="filterForm">
                        ...
                        <span class="input-group-text border-0 py-0 ps-1 pe-3">
                            ...
                            <!-- Button -->
                            <button type="submit" class="btn btn-sm btn-primary" id="filterButton">
                            Search
                            </button>
                        </span>
                  ...
                  <div class="list-group list-group-flush">
                    ...
                    <div class="me-auto">
                        ...
                        {{-- <!-- Figure -->
                        <figure class="figure" style="background-color: #B5D3FF; margin: 0; padding: 0;">
                        ...
                        <div id="imageContainer" class="figure" style="background-color: #B5D3FF; margin: 0; padding: 0;">
                            <img id="filteredImage" src="assets/img/kepuasan pelanggan/mitra/IKM_2023.png" alt="" class="figure-img img-fluid rounded" style="display: block; margin: 0; padding: 0; border: none;">
                        </div>
    ...
    <script>
        ...
        function displayImage(year) {
          const imageFilename = `assets/img/kepuasan pelanggan/mitra/IKM_${year}.png`;
