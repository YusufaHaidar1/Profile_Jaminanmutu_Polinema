            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-12 col-md-5 order-md-2">
                    ...
                    <figure class="figure mb-7">
                        <img class="figure-img img-fluid rounded lift lift-lg" src="{{ asset('assets/img/ikm_2018.png') }}" id="unsurImage" alt="Tidak Ada Informasi">
                    </figure>
                </div>
                            ...
                            <form class="rounded shadow" style="margin-bottom: 20px;" id="filterForm">
                                <div class="input-group input-group-lg mb-2">
                                    ...
                                    <select class="form-control border-0 px-1" aria-label="Pilih Kategori" id="categorySelect">
                                        ...
                                        <option value="hrm">D-IV BAHASA INGGRIS 0...</option>
                                        <option value="finance">D-IV BAHASA INGGRIS 1...</option>
                                        <option value="facilities">D-IV MANAJEMEN PEMAS2...</option>
                                        <option value="riset">D-III ADMINISTRASI BI5...</option>
                                        <option value="community">D-IV USAHA PERJALANA4...</option>
                                    </select>
                                </div>
                                ...
                                <div class="list-group-item d-flex align-items-center" style="background-color: #B5D3FF;">
                                    <div class="me-auto">
                                        ...
                                        <p id="dosenHeading" class="fw-bold mb-1 text-center" style="background-color: #B5D3FF;">
                                            GRAFIK PROSENTASE KEPUASAN MAHASISWA
                                        </p>
                                        <!-- Image Container -->
                                        <div id="imageContainer" class="figure" style="background-color: #B5D3FF; margin: 0; padding: 0;">
                                            <img id="dosenImage" src="{{ asset('assets/img/Mahasiswa_2018.png') }}" alt="Tidak Ada Informasi" class="figure-img img-fluid rounded" style="display: block; margin: 0; padding: 0; border: none;">
                                        </div>
                                    </div>
                                </div>
                            </div>
